...
{/* 
      <div className="loader">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" style={{ animationDuration: "0ms", animationDirection: "normal" }} viewBox="0 0 64 64" height="64" width="64" className="inline-block">
